"""
AWS Glue ETL Job: pl_ingest_customeradress_sqldb_adls_2
...
def main():
    ...
    # Activity: CustomerAdress_to_ADLS (Copy: AzureSqlSource -> DelimitedTextSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="CustomerAdress_to_ADLS_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="CustomerAdress_to_ADLS_sink"
    )
