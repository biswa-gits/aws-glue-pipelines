"""
AWS Glue ETL Job: pl_copy_customer_to_json
...
def main():
    ...
    # Activity: Copy_CustomerTable_To_JSON (Copy: AzureSqlSource -> JsonSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="Copy_CustomerTable_To_JSON_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="Copy_CustomerTable_To_JSON_sink"
    )
