"""
AWS Glue ETL Job: pl_scd_type_1
...
def main():
    ...
    # Activity: ACT_Copy (Copy: DelimitedTextSource -> AzureSqlSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="ACT_Copy_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="ACT_Copy_sink"
    )
