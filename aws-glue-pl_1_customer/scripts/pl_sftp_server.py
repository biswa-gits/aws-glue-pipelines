"""
AWS Glue ETL Job: pl_sftp_server
...
def main():
    ...
    # Activity: ACT_Copy_SFTP (Copy: BinarySource -> BinarySink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="ACT_Copy_SFTP_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="ACT_Copy_SFTP_sink"
    )
