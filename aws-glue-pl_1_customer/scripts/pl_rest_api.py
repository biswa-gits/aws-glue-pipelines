...
def main():
    ...
    # Activity: ACT_Get_Api_Data (Copy: RestSource -> JsonSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="ACT_Get_Api_Data_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="ACT_Get_Api_Data_sink"
    )
