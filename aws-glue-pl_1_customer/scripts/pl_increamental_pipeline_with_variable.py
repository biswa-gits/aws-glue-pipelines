"""
AWS Glue ETL Job: pl_increamental_pipeline_with_variable
...
# Pipeline Variables (from ADF)
HW_Date_var = ""  # Variable: String
DB_Date_var = ""  # Variable: String
...
def main():
    ...
    # Activity: Set variable1 (SetVariable)
    HW_Date_var = ""  # TODO: translate ADF expression value
