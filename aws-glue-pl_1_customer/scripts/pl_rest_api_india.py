"""
AWS Glue ETL Job: pl_rest_api_india
...
def main():
    ...
    # Activity: ACT_Copy_Rest_India (Copy: RestSource -> JsonSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="ACT_Copy_Rest_India_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="ACT_Copy_Rest_India_sink"
    )
