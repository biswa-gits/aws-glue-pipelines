"""
AWS Glue ETL Job: pl_copy_customer_to_csv_pipe
...
def main():
    ...
    # Activity: Copy_Customer_To_CSV (Copy: AzureSqlSource -> DelimitedTextSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="Copy_Customer_To_CSV_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="Copy_Customer_To_CSV_sink"
    )
