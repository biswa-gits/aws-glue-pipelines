"""
AWS Glue ETL Job: pl_copy_customer_json_to_folder
...
def main():
    ...
    # Activity: Copy_Customer_JSON_To_Folder (Copy: DelimitedTextSource -> DelimitedTextSink)
    source_df = glueContext.create_dynamic_frame.from_options(
        connection_type="s3",
        format="csv",
        connection_options={"paths": [SOURCE_PATH]},
        transformation_ctx="Copy_Customer_JSON_To_Folder_source"
    )
    ...
    sink_df = glueContext.write_dynamic_frame.from_options(
        ...
        transformation_ctx="Copy_Customer_JSON_To_Folder_sink"
    )
